...
# ============================================================
# Signal-Quality-Aware LR Scaling experiment
# ============================================================
# α_t = α_base * q_t^info [* q_t^conc]
#
# Environment variables:
#   SQ_BASE_LR    — base (aggressive) LR          (default: 1e-5)
#   SQ_TAG        — short tag for filenames        (default: sq_info)
#   SQ_INFO_SRC   — reward_std_median / frac_informative / mean_a2
#   SQ_USE_CONC   — true/false                     (default: false)
#   SQ_CONC_SRC   — cv2_h / cv2_a2                 (default: cv2_h)
#   SEED          — random seed                    (default: 42)
#   NCPUS         — Ray CPUs                       (default: nproc)
# ============================================================

SQ_BASE_LR=${SQ_BASE_LR:-"1e-5"}
SQ_TAG=${SQ_TAG:-"sq_info"}
